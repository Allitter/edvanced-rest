...
create sequence certificate_id_seq increment 5 start 4;
create sequence purchase_certificate_id_seq increment 5 start 4;
create sequence purchase_id_seq increment 5 start 4;
create sequence tag_id_seq increment 5 start 4;
create sequence users_id_seq increment 5 start 4;
